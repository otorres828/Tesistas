...
<head>
	...
	<title>Escuela| Empresas - Cargar Empresas</title>
	<?php
...
<body class="sidebar-mini layout-fixed vsc-initialized layout-navbar-fixed sidebar-closed ">
	...
	<?php include_once('../public/Views/componentes/indexSidebar.php'); ?>
		...
		<div class="content-wrapper p-5">
			<div class="container">
				<form action="escuela-empresas-cargar" method="POST" enctype="multipart/form-data">
								...
								while ($datos = fgetcsv($fp, 5000, ";")) {
									...
									if ($rows > 1) {
										...
										if($resultado){
											...
											$query = "INSERT INTO  empresas(nombre,slug) VALUES('$nombre','$slug')";
											
											$valor = (new Empresas())->insertarObj($query);
